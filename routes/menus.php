...
Route::middleware(['auth', 'school_user'])->prefix('school')->name('school.')->group(function () {
    Route::middleware('school_subscription')->group(function () {
        ...
        Route::middleware('school_admin')->group(function () {
            Route::get('/users-view', [App\Http\Controllers\School\UserController::class, 'index'])->name('users-view');
            Route::get('/user-add', [App\Http\Controllers\School\UserController::class, 'create'])->name('user-add');
        });
    });
});
